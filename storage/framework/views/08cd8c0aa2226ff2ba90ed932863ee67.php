...
<head>
    ...
    <title>Confirmation commande #<?php echo e($commande->id); ?></title>
    <style>
...
<div class="wrapper">
    ...
    <div class="body">
        ...
        <p>Bonjour <strong><?php echo e($commande->prenom); ?> <?php echo e($commande->nom); ?></strong>,</p>
        <p>Votre commande <strong>#<?php echo e($commande->id); ?></strong> a bien été enregistrée. Notre équipe vous contactera au <strong><?php echo e($commande->telephone); ?></strong> pour confirmer la livraison.</p>
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <span><?php echo e($commande->prenom); ?> <?php echo e($commande->nom); ?></span>
            </div>
            <div class="info-item">
                <label>Téléphone</label>
                <span><?php echo e($commande->telephone); ?></span>
            </div>
            <div class="info-item">
                <label>Ville</label>
                <span><?php echo e($commande->ville); ?></span>
            </div>
            <div class="info-item">
                <label>Adresse</label>
                <span><?php echo e($commande->adresse); ?></span>
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                <?php $__currentLoopData = $commande->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($item->betail): ?>
                    <tr>
                        <td><?php echo e($item->betail->race); ?></td>
                        <td><?php echo e($item->quantite); ?></td>
                        <td><?php echo e(number_format($item->prix_unitaire, 0, ',', ' ')); ?> FCFA</td>
                        <td><?php echo e(number_format($item->prix_unitaire * $item->quantite, 0, ',', ' ')); ?> FCFA</td>
                    </tr>
                    <?php endif; ?>
    ...
    <div class="footer">
        <p>Merci de votre confiance — <a href="<?php echo e(url('/')); ?>">SagaChap</a></p>
...
<?php /**PATH D:\Own project\saga_chap\resources\views/emails/commande-confirmation.blade.php ENDPATH**/ ?>
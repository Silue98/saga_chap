...
<?php $component->withAttributes([]); ?>
    <!--[if BLOCK]><![endif]--><?php if($nbEnAttente > 0): ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-6 w-6 text-warning-600 dark:text-warning-400']); ?>
...
<?php endif; ?>
            ...
            <div class="flex-1">
                <p class="text-sm font-semibold text-warning-800 dark:text-warning-200">
                    <?php echo e($nbEnAttente); ?> commande<?php echo e($nbEnAttente > 1 ? 's' : ''); ?> en attente de traitement
                </p>
                <p class="text-xs text-warning-600 dark:text-warning-400">
                    Cliquez sur "Commandes" pour les traiter
                </p>
            </div>
            <a href="<?php echo e(route('filament.admin.resources.commandes.index')); ?>"
...
<?php endif; ?>
<?php /**PATH D:\Own project\saga_chap\resources\views/filament/widgets/nouvelles-commandes.blade.php ENDPATH**/ ?>